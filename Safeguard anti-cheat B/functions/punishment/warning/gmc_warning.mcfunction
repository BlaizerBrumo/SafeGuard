...
scoreboard players add @s gmc_warning 1
...
execute @s[scores={gmc_warning=3}] ~~~ tellraw @s {"rawtext": [{"text": "§6[§eSafeGuard§6]§r§l§c "},{"text": "§4Next warning will result in a permanent ban!"}]}