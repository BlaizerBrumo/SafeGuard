...
execute @a[scores={anti_cbe_on=0}] ~~~ execute @a[tag=!admin,hasitem={item=bee_nest}] ~~~ tellraw @a[scores={notify=1}] {"rawtext":[{"text":"§6[§eSafeGuard§6]§r§c§l "},{"selector":"@s"},{"text":" §r§4Was detected having illegal item: §l§cBEE NEST!§r"}]}
execute @a[scores={anti_cbe_on=0}] ~~~ execute @a[tag=!admin,hasitem={item=beehive}] ~~~ tellraw @a[scores={notify=1}] {"rawtext":[{"text":"§6[§eSafeGuard§6]§r§c§l "},{"selector":"@s"},{"text":" §r§4Was detected having illegal item: §l§cBEEHIVE!§r"}]}
